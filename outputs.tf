...
output "instance_name" {
  value       = module.google_postgres_db.instance_name
  description = "The instance name for the master instance"
}

output "instance_ip_address" {
  value       = module.google_postgres_db.instance_ip_address
  description = "The IPv4 address assigned for the master instance"
}

output "private_ip_address" {
  value       = module.google_postgres_db.private_ip_address
  description = "The first private (PRIVATE) IPv4 address assigned for the master instance"
}

output "instance_first_ip_address" {
  value       = module.google_postgres_db.instance_first_ip_address
  description = "The first IPv4 address of the addresses assigned for the master instance."
}

output "instance_connection_name" {
  value       = module.google_postgres_db.instance_connection_name
  description = "The connection name of the master instance to be used in connection strings"
}

output "instance_self_link" {
  value       = module.google_postgres_db.instance_self_link
  description = "The URI of the master instance"
}

output "instance_server_ca_cert" {
  value       = module.google_postgres_db.instance_server_ca_cert
  description = "The CA certificate information used to connect to the SQL instance via SSL"
}

output "instance_service_account_email_address" {
  value       = module.google_postgres_db.instance_service_account_email_address
  description = "The service account email address assigned to the master instance"
}

// Replicas
output "replicas_instance_first_ip_addresses" {
  value       = module.google_postgres_db.replicas_instance_first_ip_addresses
...
output "replicas_instance_connection_names" {
  value       = module.google_postgres_db.replicas_instance_connection_names
...
output "replicas_instance_self_links" {
  value       = module.google_postgres_db.replicas_instance_self_links
  description = "The URIs of the replica instances"
}

output "replicas_instance_server_ca_certs" {
  value       = module.google_postgres_db.replicas_instance_server_ca_certs
...
output "replicas_instance_service_account_email_addresses" {
  value       = module.google_postgres_db.replicas_instance_service_account_email_addresses
  description = "The service account email addresses assigned to the replica instances"
}

output "read_replica_instance_names" {
  value       = module.google_postgres_db.read_replica_instance_names
...
output "public_ip_address" {
  ...
  value       = module.google_postgres_db.public_ip_address
}
